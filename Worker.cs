    ...
    public class Worker : BackgroundService
    {
        ...
        protected override async Task ExecuteAsync(CancellationToken stoppingToken)
        {
            while (!stoppingToken.IsCancellationRequested)
            {
                ...
                try
                {
                   ...
                   // string accesstoken = File.ReadAllText(@"C:\Token\MIPAPITok1.txt");
                 ...
                 /*   if (accesstoken.access_token == null)
                      {
                          ...
                          Log.Information("Stopping existing Access Token " + DateTime.Now.ToString() + accesstoken);
                      ...
                      string refreshtoken1 = File.ReadAllText(@"C:\Token\MIPRefTok.txt");
                      ...
                      await Task.Delay(20000);
                                ...
                                var zohopar1 = new RestRequest(zoho_base_url + "search?criteria=((Comp_Code:equals:" + _appSettings.compcode + ")and(Stage:equals:Policy%20fulfillment)and(product:starts_with:4))");
                                zohopar1.AddHeader("Authorization", "Zoho-oauthtoken " + acctoken2);
                                var res1 = await zohoclient.GetAsync(zohopar1);
                    var zohoID = new ZohoResponse();
                    zohoID = JsonConvert.DeserializeObject<ZohoResponse>(res1.Content);
                                    ...
                                    if (resultconv.Data != null)
                                    {
                                        for (int i = 0; i <= resultconv.Data.Length; i++)
                                        {
                                            using (SqlConnection con = new SqlConnection(_config.GetConnectionString("MIP")))
                                            {
                                                ...
                                                if (exists/*.Count()*/ == 0)
                                                {
                                                    ...
                                                    if (!IsPolicyNumberExistsinDB)
                                                    {
                                                        ...
                                                        if (resultconv.Data[i].id_type == "SA" && resultconv.Data[i].Id_Number1 == null)
                                                        {
                                                            mip.IDNumber = resultconv.Data[i].id_number;
                                                            mip.PassportNumber = "";
                                                        }
                                                        else if (resultconv.Data[i].id_type == "Passport" && resultconv.Data[i].Id_Number1 == null)
                                                        {
                                                            mip.PassportNumber = resultconv.Data[i].id_number;
                                                            mip.IDNumber = "";
                                                        }
                                            else if (resultconv.Data[i].id_type == "SA" && resultconv.Data[i].id_number == null)
                                            {
                                                mip.IDNumber = resultconv.Data[i].Id_Number1;
                                                mip.PassportNumber = "";
                                            }
                                            else if (resultconv.Data[i].id_type == "Passport" && resultconv.Data[i].id_number == null)
                                            {
                                                mip.PassportNumber = resultconv.Data[i].Id_Number1;
                                                mip.IDNumber = "";
                                            }
                                            mip.DateOfBirth = resultconv.Data[i].date_of_birth;
                                                        mip.Gender = resultconv.Data[i].gender[0].ToString();//change to first letter
                                                        mip.Initials = $"{mip.FirstName[0]}";
                                                        mip.EmployerName = resultconv.Data[i].Comp_Code;
                                                        mip.EmploymentDate = _appSettings.EmploymentDate;
                                                        mip.StatusDescription = "Active";
                                                        ...
                                                        pol.AccountHolder = resultconv.Data[i].Account_Holder_Initial + " " + resultconv.Data[i].account_holder_name;//Account_Holder_Initial,account_holder_name
                                            pol.AccountTypeCode = resultconv.Data[i].account_type;
                                                        ...
                                                        pol.ClaimAccountHolder = resultconv.Data[i].Account_Holder_Initial + " " + resultconv.Data[i].account_holder_name;//Account_Holder_Initial,account_holder_name
                                            if (resultconv.Data[i].account_type == "Cheque")
                                                        {
                                                        ...
                                                        pol.AccHolderID = resultconv.Data[i].Account_Holder_ID_Passport; //Account_Holder_ID_Passport
                                          /*  if (resultconv.Data[i].id_type == "SA" && resultconv.Data[i].Id_Number1 == null)
                                            {
                                            ...
                                            {
                                                pol.AccHolderID = resultconv.Data[i].Id_Number1;
                                            }
                                            else if (resultconv.Data[i].id_type == "Passport" && resultconv.Data[i].id_number == null)
                                            {
                                                pol.AccHolderID = resultconv.Data[i].Id_Number1;
                                            ...
                                            pol.AVSComp = _appSettings.AVSCode;//config set
                                                        ...
                                                        pol.EthnicGroup = "U"; //resultconv.Data[i].race;
                                                ...
                                                if (resultconv.Data[i].id_type == "SA" && resultconv.Data[i].id_number == null)
                                                {
                                                    depd.IDNumber = resultconv.Data[i].Id_Number1;
                                                    depd.PassportNumber = "";
                                                }
                                                else if (resultconv.Data[i].id_type == "Passport" && resultconv.Data[i].id_number == null)
                                                {
                                                    depd.PassportNumber = resultconv.Data[i].Id_Number1;
                                                    depd.IDNumber = "";
                                                }
                                                depd.DateOfBirth = resultconv.Data[i].date_of_birth;
                                                            ...
                                                            if (depd.DependantRelationship == "Main")
                                                            {
                                                                depd.DependantTypeCode = _appSettings.MainType;
                                                            }
                                                            else if (depd.DependantRelationship == "Adult Dep")
                                                            {
                                                        ...
                                                        if (resultconv.Data[i].dep1name != null)
                                                        {
                                                            ...
                                                            if (resultconv.Data[i].Dep_1_Type == "Adult")
                                                            {
                                                                depd.DependantRelationship = "Adult Dep";
                                                            }
                                                            else
                                                            {
                                                                depd.DependantRelationship = resultconv.Data[i].Dep_1_Type;
                                                            }
                                                            if (depd.DependantRelationship == "Adult Dep" || depd.DependantRelationship == "Spouse")
                                                            {
                                                        ...
                                                        if (resultconv.Data[i].dep2name != null)
                                                        {
                                                            ...
                                                            if (resultconv.Data[i].Dep_2_Type == "Adult")
                                                            {
                                                                depd.DependantRelationship = "Adult Dep";
                                                            }
                                                            else
                                                        ...
                                                        if (resultconv.Data[i].dep3name != null)
                                                        {
                                                            ...
                                                            if (resultconv.Data[i].Dep_3_Type == "Adult")
                                                            {
                                                                depd.DependantRelationship = "Adult Dep";
                                                            }
                                                            else
                                                        ...
                                                        if (resultconv.Data[i].dep4name != null)
                                                        {
                                                            ...
                                                            if (resultconv.Data[i].Dep_4_Type == "Adult")
                                                            {
                                                                depd.DependantRelationship = "Adult Dep";
                                                            }
                                                            else
                                                        ...
                                                        if (resultconv.Data[i].dep5name != null)
                                                        {
                                                            ...
                                                            if (resultconv.Data[i].Dep_5_Type == "Adult")
                                                            {
                                                                depd.DependantRelationship = "Adult Dep";
                                                            }
                                                            else
                                                        ...
                                                        if (resultconv.Data[i].dep6name != null)
                                                        {
                                                            ...
                                                            if (resultconv.Data[i].Dep_6_Type == "Adult")
                                                            {
                                                                depd.DependantRelationship = "Adult Dep";
                                                            }
                                                            else
                                                        ...
                                                        if (resultconv.Data[i].dep7name != null)
                                                        {
                                                            ...
                                                            if (resultconv.Data[i].Dep_7_Type == "Adult")
                                                            {
                                                                depd.DependantRelationship = "Adult Dep";
                                                            }
                                                            else
                                                        ...
                                                        if (resultconv.Data[i].dep8name != null)
                                                        {
                                                            ...
                                                            if (resultconv.Data[i].Dep_8_Type == "Adult")
                                                            {
                                                                depd.DependantRelationship = "Adult Dep";
                                                            }
                                                            else
                                                        ...
                                                        if (resultconv.Data[i].dep9name != null)
                                                        {
                                                            ...
                                                            if (resultconv.Data[i].Dep_9_Type == "Adult")
                                                            {
                                                                depd.DependantRelationship = "Adult Dep";
                                                            }
                                                            else
                                                        ...
                                                        if (resultconv.Data[i].dep10name != null)
                                                        {
                                                            ...
                                                            if (resultconv.Data[i].Dep_10_Type == "Adult")
                                                            {
                                                                depd.DependantRelationship = "Adult Dep";
                                                            }
                                                            else
                                                        ...
                                                        Log.Information("MIP Service Start");
                                                        var client = new RestClient(options);
                                                        var request = new RestRequest(_appSettings.environment, Method.Post);
                                                        //request.Method = Method.Post;
                                                        Log.Information("MIP Service URL " + _appSettings.environment);
                                                        ...
                                                        // Log.Information("MIP Service Request " + request);
                                                        ...
                                                        if (mipResponse.data != null)
                                                        {
                                                            ...
                                                            Log.Information(mipResponse.data.ToString());
                                                            ...
                                                            if (MIPErrorResponse == false && mipResponse.data[0].RESPONSE_MESSAGE.Contains("created")|| MIPErrorResponse == false && mipResponse.data[0].RESPONSE_MESSAGE.Contains("updated"))
                                                            {
        ...
        public async Task<MIPAuthResponse> GetAuthToken()
        {
            try
            {
               ...
               File.WriteAllText(@"C:\Token\MIPRefTok.txt", response.refresh_token);
