...
namespace MIPService.Models
{
    ...
    public class MITable
    {
        ...
        public string Mandate_Reference { get; set; }
        public string Account_Type { get; set; }
        public string Account_Number { get; set; }
        public string BranchCode { get; set; }
        public string Account_Holder_Name { get; set; }
        public string Debit_Order_Date { get; set; }
        public string account_type_clm { get; set; }
        public string account_num_clm { get; set; }
        public string branch_code_clm { get; set; }
        public string account_name_clm { get; set; }
